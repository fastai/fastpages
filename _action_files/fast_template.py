...
def rename_for_jekyll(nb_path: Path, warnings: Set[Tuple[str, str]]=None, force_date = True) -> str:
    """
    ...
    if force_date and _re_blog_date.match(nb_path.name): return nb_path.with_suffix('.md').name.replace(' ', '-')
